...
<title><s:property value="author.authorName" />简介</title>
			...
			<div class="w-224 fl">
				<div class="uinfo author-info bdrbox">
					<div class="usr-avatar">
						<a href="javascript:;"
							title="<s:property value="author.authorName" />"><img
							class="trans-04s" src="<s:property value="author.photo" />"></a>
					</div>
					<p class="author-dtl">
						<span>笔名：<s:property value="author.authorName" /></span> <span>性别：<s:property
								value="author.sex" /></span><span>签约：<s:property
								value="author.web" /></span> <span>籍贯：<s:property
								value="author.address" /></span>
					</p>
			...
			<div class="w-746 fr">
				<div class="sch-result st-list" id="sch-result">
					<div class="bdrbox sch-res-top">
						<p class="fl">
							<a style="text-decoration: none;"><s:property
									value="author.authorName" />的作品(<s:property
									value="author.finished" />)</a>
						</p>
					</div>
					<s:if test="#request.blist!=null">
						<div class="rank-body">
							<s:iterator status="spin1" value="#request.blist" id="s">
								<li id="list" id=<s:property value="#s.novel_id" />>
									<div class="book-img-box">
										<span class="rank-tag"><s:property value="#spin1.count" /><cite></cite></span>
